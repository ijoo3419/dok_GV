												...
												<tr>
													...
													<c:choose>
														...
														<c:when test="${ status eq '취소불가_리뷰가능' }">
															<td><img id="review${ bk.movie_id }" src="${ contextPath }/resources/images/member/rating.png" width="25" height="25" style="margin-left:10px; margin-top:10px;" onclick='reviews("${ bk.movie_id }");'></td>
														</c:when>
													</c:choose>
												</tr>
											</tbody>
